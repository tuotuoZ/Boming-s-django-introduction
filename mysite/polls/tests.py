...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        this function returns False for questions whose pub_date is in the future.
        """
    ...
    def test_was_published_recently_with_old_question(self):
        """
        this function returns False for questions whose pub_date is older than 1 day.
        """
        time = timezone.now() - datetime.timedelta(days=30)
...
def create_question(question_text, days):
    """
    :param question_text: create a question with given text
    :param days: offset to now. Negative for questions published in the past, vice versa.
